/*
	Build canonical Query Store observations from lossless contributor rows.
	Standard deviation is retained only for a single native contributor because
	Microsoft does not document whether Query Store exposes sample or population
	standard deviation.
*/
...
GO
CREATE OR ALTER PROCEDURE dbo.usp_MaterializeCanonicalQueryStoreStats
	@RunID INT,
