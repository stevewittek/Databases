/* One complete archived runtime observation at Microsoft's documented grain. */

CREATE TABLE dbo.query_store_runtime_stats_canonical
(
	RunID INT NOT NULL,
	...
	CONSTRAINT PK_query_store_runtime_stats_canonical
		PRIMARY KEY NONCLUSTERED
		(RunID, plan_id, execution_type, runtime_stats_interval_id),
	CONSTRAINT CK_query_store_runtime_stats_canonical_stdev
		CHECK (stdev_aggregation_status IN
			(N'NATIVE_SINGLE_CONTRIBUTOR', N'UNAVAILABLE_MULTIPLE_CONTRIBUTORS')),
	CONSTRAINT CK_query_store_runtime_stats_canonical_state
		CHECK (observation_state IN (N'COMPLETED', N'PROVISIONAL'))
) ON PS_RunID(RunID);
GO
CREATE CLUSTERED COLUMNSTORE INDEX CCI_query_store_runtime_stats_canonical
	ON dbo.query_store_runtime_stats_canonical
